...
function setup() {
  ...
  ran1 = new Box(random(500,800),random(100,600),30,30);
  ran2 = new Box(random(500,800),random(100,600),30,30);
  ran3 = new Box(random(500,800),random(100,600),30,30);
  ran4 = new Box(random(500,800),random(100,600),30,30);
}
